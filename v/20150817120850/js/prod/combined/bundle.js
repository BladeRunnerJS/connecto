...
define('shivie8', function(require, exports, module) {
module.exports = null;
});


window.shivie8 = require('shivie8');
...
// emitr built for browser 2015-07-03T09:30:46.613Z
			...
			for (var i = 0, len = listeners.length; i < len; ++i) {
				...
				try {
					...
					if(typeof console !== 'undefined' && typeof console.error !== 'undefined') {
						console.error("Error notifying an observer, the error was: '" + e + "'");
					}
				}
			}
			return true;
...
module.exports.APP_VERSION = '20150817120850';
module.exports.VERSIONED_BUNDLE_PATH = 'v/20150817120850';
module.exports.LOCALE_COOKIE_NAME = 'BRJS.LOCALE';
module.exports.APP_LOCALES = {'en':true};
});
...
// alias!$data
define('alias!$data', function(require, exports, module) {
module.exports = {'br.event-hub':{'class':'br/EventHub','className':'br.EventHub'},'br.app-meta-service':{'class':'br/services/appmeta/BRAppMetaService','className':'br.services.appmeta.BRAppMetaService'},'br.html-service':{'class':'br/services/html/BRHtmlResourceService','className':'br.services.html.BRHtmlResourceService'}};
});


// translations/Translations
define('translations/Translations', function(require, exports, module) {
"use strict";
...
Translations.prototype.transport = [
			...
			{
				english:"horsecart",
				french: "l'hélicoptère",
				spanish: "el carruaje"
			},
			{
				english:"hot air balloon",
				french: "le ballon à air chaud",
				spanish: "el globo de aire caliente"
			},
			{
				english:"motorcycle",
				french: "la moto",
			...
			{
				english:"rollerblades",
				french: "",
				spanish: "los patines en línea"
			},
			{
				english:"rollerskates",
				french: "",
				spanish: "los patines sobre ruedas"
			},
			{
				english:"sailingboat",
				french: "la fusée",
			...
			},
			{
				english:"skateboard",
				french: "",
				spanish: "el monopatín"
			},
			{
				english:"spaceship",
				french: "",
				spanish: "la nave espacial"
			},
			{
				english:"speedboat",
				french: "la planche à roulettes",
				spanish: "la lancha"
			},
			{
				english:"submarine",
				french: "le sous-marin",
				spanish: "el submarino"
			},
			{
				english:"taxi",
				french: "",
			...
			},
			{
				english:"van",
				french: "le van",
				spanish: "la camioneta"
			},
			{
				english:"wheelchair",
				french: "le fauteuil roulant",
...
Translations.prototype.vegetables = [
			...
			{
				english:"bok choy",
				french: "le chou chinois",
				spanish: "el repollo chino"
			},
			{
				english:"broccoli",
				french: "les brocolis",
			...
			},
			{
				...
				french: "les choux de Bruxelles",
				spanish: "las coles de bruselas"
			},
			{
				english:"cabbage",
				french: "le chou",
			...
			{
				english:"chickpeas",
				french: "les pois chiches",
				spanish: "los garbanzos"
			},
			{
				english:"corn",
				french: "le maïs",
			...
			{
				english:"lentils",
				french: "les lentilles",
				spanish: "las lentejas"
			},
			{
				english:"lettuce",
				french: "la laitue",
			...
			{
				english:"peas",
				french: "les petits pois",
				spanish: "los guisantes"
			},
			{
				english:"pepper",
				french: "le poivre",
...
define('randomator/Randomator', function(require, exports, module) {
"use strict";
...
// br/AliasInterfaceError
define('br/AliasInterfaceError', function(require, exports, module) {
...
// br/component/Frame
define('br/component/Frame', function(require, exports, module) {
/**
...
// alias!br.event-hub
define('alias!br.event-hub', function(require, exports, module) {
	module.exports = require('br/AliasRegistry').getClass('br.event-hub');
});
...
// br/component/SimpleFrame
define('br/component/SimpleFrame', function(require, exports, module) {
/**
...
// alias!br.app-meta-service
define('alias!br.app-meta-service', function(require, exports, module) {
	module.exports = require('br/AliasRegistry').getClass('br.app-meta-service');
});
...
// lang/play/grid/Column
define('lang/play/grid/Column', function(require, exports, module) {
'use strict';
...
// service!br.event-hub
define('service!br.event-hub', function(require, exports, module) {
	module.preventCaching = true;
	module.exports = require('br/ServiceRegistry').getService('br.event-hub');
});


// lang/play/choices/ChoicesViewModel
define('lang/play/choices/ChoicesViewModel', function(require, exports, module) {
'use strict';
...
// lang/play/settings/SettingsViewModel
define('lang/play/settings/SettingsViewModel', function(require, exports, module) {
'use strict';
...
define('service!br.app-meta-service', function(require, exports, module) {
	module.preventCaching = true;
	module.exports = require('br/ServiceRegistry').getService('br.app-meta-service');
});


// lang/play/grid/GridViewModel
define('lang/play/grid/GridViewModel', function(require, exports, module) {
'use strict';
...
// alias!br.html-service
define('alias!br.html-service', function(require, exports, module) {
	module.exports = require('br/AliasRegistry').getClass('br.html-service');
});


// lang/App
define('lang/App', function(require, exports, module) {
'use strict';
...
// service!br.html-service
define('service!br.html-service', function(require, exports, module) {
	module.preventCaching = true;
	module.exports = require('br/ServiceRegistry').getService('br.html-service');
});
